      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              <>
                <button onClick={NavigateHistory} className="text-gray-600 hover:text-gray-900 px-3 py-2">History</button>
                <button onClick={handleLogout} className="text-gray-600 hover:text-gray-900 px-3 py-2">Logout</button>
              </>
            ) : (
              <>
